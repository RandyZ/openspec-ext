...
- **Open VSX**: [OpenSpec Workflow 0.2.2](https://open-vsx.org/extension/randysss/openspec-workflow) is published (publisher `randysss`, extension id `openspec-workflow`).
