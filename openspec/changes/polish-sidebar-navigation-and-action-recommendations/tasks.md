<!-- Implementation details are in openspec/changes/polish-sidebar-navigation-and-action-recommendations/task-details/. Each ## Task N group references one task group file; Task N.M ids correspond 1-to-1 with ### Task blocks across files. -->
